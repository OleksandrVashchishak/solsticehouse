...
/***/ "./src/js/template_parts/banner.es6":
/*!******************************************!*\
  !*** ./src/js/template_parts/banner.es6 ***!
  \******************************************/
/***/ (function() {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  bannerButton.addEventListener('click', function (e) {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        var iframe = document.querySelector('.spinner iframe');
        if (iframe) {
...
var tourIframe = document.querySelector('.popup__simple.tour iframe, .popup__simple-tour');
var isBookModal = document.querySelector('.book-modal');
var tourUrl = tourIframe ? tourIframe.getAttribute('data-url') : null;
var openSpinnerTour = function openSpinnerTour() {
  var iframe = document.querySelector('.spinner iframe');
  ...
  iframe.contentWindow.postMessage({
    type: "OPEN_SPINNER_TOUR"
  }, targetOrigin);
  headerPopup && headerPopup.classList.remove('open');
  return true;
};
var openSpinnerFloorMap = function openSpinnerFloorMap() {
  var iframe = document.querySelector('.spinner iframe');
  if (!iframe) return false;
  var targetOrigin = '*';
  try {
...
var isTourOpenMobile = function isTourOpenMobile() {
  var footerBtns = document.querySelector('.footer__buttons');
  return !!(footerBtns && footerBtns.classList.contains('hide') && window.innerWidth <= 900);
};
var isTourMenuLink = function isTourMenuLink(link) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var popup = document.querySelector('.header__popup');
  var closeButton = document.querySelector('.header__popup-close');
...
var bookDemoModal = function bookDemoModal() {
  var popup = document.querySelector('#contact-form');
  if (!popup) return;
  popup.classList.add('open');
};
document.addEventListener('DOMContentLoaded', function () {
  var menuLinks = document.querySelectorAll('.header__popup-menu a');
  var headerContacts = document.querySelectorAll('.header__contact');
  var footerPdf = document.querySelector('.footer__price');
  var headerPopup = document.querySelector('.header__popup');
  menuLinks.forEach(function (link) {
    ...
    link.addEventListener('click', function (e) {
      ...
      if (link.parentElement.classList.contains('pdf-link') && window.innerWidth < 900) {
        e.preventDefault();
        window.open('https://clearviewdrive.app/wp-content/uploads/2026/03/Clear-View-Drive-Collateral.pdf', '_blank', 'noopener');
  ...
  headerContacts.forEach(function (headerContact) {
    headerContact.addEventListener('click', function (e) {
      e.preventDefault();
      bookDemoModal();
    });
  });
  footerPdf.addEventListener('click', function (e) {
    if (!isBookModal) {
      var href = footerPdf.getAttribute('href');
      if (!href || !href.startsWith('#')) return;
      var popup = document.querySelector(href);
      if (!popup) return;
      e.preventDefault();
  ...
  document.addEventListener('click', function (e) {
    if (e.target.classList.contains('popup__contact-close')) {
      var popup = e.target.closest('.popup__contact');
      var thanksBlock = popup.querySelector('.popup__thanks');
...
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('popup__simple-close')) {
    var popup = e.target.closest('.popup__simple');
...
document.addEventListener('wpcf7mailsent', function (event) {
  var popup = event.target.closest('.popup__contact');
  var thanksBlock = popup.querySelector('.popup__thanks');
...
window.addEventListener("message", function (event) {
  if (event.data.type === "OPEN_WP_MODAL") {
    var popup = document.querySelector('.popup__contact');
    popup.classList.add('open');
  }
});
window.addEventListener("message", function (event) {
  if (event.data.type === "OPEN_WP_PDF") {
    var popup = document.querySelector('.popup__contact.second');
    popup.classList.add('open');
  }
});
var apartmentsLink = document.querySelector('.apartments-link');
apartmentsLink && apartmentsLink.addEventListener('click', function (e) {
  e.preventDefault();
  var iframe = document.querySelector('.spinner iframe');
  var headerPopup = document.querySelector('.header__popup');
...
var toursLinks = document.querySelectorAll('.tours-link');
toursLinks.forEach(function (toursLink) {
  toursLink && toursLink.addEventListener('click', function (e) {
    e.preventDefault();
    if (isBookModal) {
      bookDemoModal();
      return;
...
var contacts = document.querySelectorAll('.popup__contact');
var modals = document.querySelectorAll('.popup__simple');
modals.length && modals.forEach(function (modal) {
  var wrapper = modal.querySelector('.popup__simple-wrapper');
...
contacts.length && contacts.forEach(function (contact) {
  var wrapperContact = contact.querySelector('.popup__contact-wrapper');
...
document.addEventListener("DOMContentLoaded", function () {
  var popup = document.querySelector(".popup__simple.video");
  if (!popup) return;
  var video = popup.querySelector(".popup__simple-video");
  var playBtn = popup.querySelector(".popup__simple-play");
  var preview = popup.querySelector(".popup__simple-prev");
  var closeBtn = popup.querySelector(".popup__simple-close");
...
document.addEventListener("DOMContentLoaded", function () {
  var initPopupGallery = function initPopupGallery(root) {
    if (!root) return;
    var img = root.querySelector(".popup__gallery-img");
    var thumbs = Array.prototype.slice.call(root.querySelectorAll(".popup__gallery-thumb"));
    var currentEl = root.querySelector(".popup__gallery-current");
    var prevBtn = root.querySelector(".popup__gallery-prev");
    var nextBtn = root.querySelector(".popup__gallery-next");
    ...
    var show = function show(i) {
      ...
      thumbs.forEach(function (t, ti) {
        if (ti === index) t.classList.add("is-active");else t.classList.remove("is-active");
      });
    };
  ...
  Array.prototype.forEach.call(document.querySelectorAll(".popup__simple.gallery, .popup__simple.floorplan"), initPopupGallery);
});
var footerBtns = document.querySelector('.footer__buttons');
window.addEventListener("message", function (event) {
...
(function ($) {
  $(".header").length > 0 && __webpack_require__(/*! ./template_parts/header.es6 */ "./src/js/template_parts/header.es6");
})(jQuery);
(function ($) {
  $(".banner").length > 0 && __webpack_require__(/*! ./template_parts/banner.es6 */ "./src/js/template_parts/banner.es6");
})(jQuery);
}();
/******/ })()
;
